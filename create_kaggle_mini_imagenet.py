...
with open("f:/FSCIL/ACHG-CLIP/run_mini_imagenet.py", "r", encoding="utf-8") as f:
    run_mini_imagenet_content = f.read()
...
cells = [
    {
        ...
        "metadata": {},
        "source": [
            "# ACHG-CLIP: Experiment B2 (ViT-L/14 Backbone Study) - miniImageNet\n",
            "This notebook trains and evaluates the ACHG-CLIP model on miniImageNet FSCIL using the **ViT-L/14** backbone with **Seed 42**."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "outputs": [],
        "source": [
            "# Write latest run_mini_imagenet.py\n",
            f"code_cifar = {json.dumps(run_mini_imagenet_content)}\n",
            "with open('run_mini_imagenet.py', 'w', encoding='utf-8') as f:\n",
            "    f.write(code_cifar)\n",
            "print('Updated run_mini_imagenet.py')\n",
            "\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "cmd = [sys.executable, 'run_mini_imagenet.py', '--variant', 'ViT-L/14', '--seed', '42', '--data_root', '/kaggle/input/miniimagenet']\n",
            "\n",
    ...
    },
    {
        ...
        "source": [
            ...
            "    dest = '/kaggle/working/Backbone_CLIP_C_ViTL14_miniImageNet'\n",
...
os.makedirs("f:/FSCIL/kaggle_runner_mini_imagenet", exist_ok=True)
with open("f:/FSCIL/kaggle_runner_mini_imagenet/achg_clip_vit_large_miniimagenet.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print("Created f:/FSCIL/kaggle_runner_mini_imagenet/achg_clip_vit_large_miniimagenet.ipynb successfully!")
