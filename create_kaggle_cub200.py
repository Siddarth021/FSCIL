...
with open("f:/FSCIL/ACHG-CLIP/run_cub200.py", "r", encoding="utf-8") as f:
    run_cub200_content = f.read()
...
cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            f"code_cifar = {json.dumps(run_cub200_content)}\n",
...
os.makedirs("f:/FSCIL/kaggle_runner_cub200", exist_ok=True)
with open("f:/FSCIL/kaggle_runner_cub200/achg_clip_vit_large_cub200.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print("Created f:/FSCIL/kaggle_runner_cub200/achg_clip_vit_large_cub200.ipynb successfully!")
