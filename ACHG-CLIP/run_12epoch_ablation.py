...
def main():
    print("==============================================")
    print("Starting 12-Epoch Base Training Ablation")
    print("==============================================")
    ...
    try:
        ...
        # 2. Run script with resume argument from the 9-epoch run
        checkpoint_path = r"results\run_01092026_065925\latest_checkpoint.pt"
